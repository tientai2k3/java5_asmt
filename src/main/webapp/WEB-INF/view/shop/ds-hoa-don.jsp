...
<div class="container">
    ...
    <br />
    <div class="container">
        <h4><center>DANH SÁCH HÓA ĐƠN</center></h4>
        <hr>
        ...
        <c:if test="${not ds.isEmpty()}">
            <table class="table">
                ...
                <tbody>
                <c:forEach items="${ds}" var="hd" varStatus="a">
                    <tr>
                        ...
                        <td><a class="btn btn-info" onclick="return confirm('Bạn có muốn xem chi tiết ?')" href="/shop-dong-ho/ds-hoa-don/xem-chi-tiet/${hd.id}">Xem chi tiết</a></td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
